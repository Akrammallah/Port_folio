...
export default function ContactForm() {
  ...
  return (
    <div className="container m-auto  py-12 px-4 sm:p-6 lg:px-8 grid sm:grid-cols-2 grid-cols-1 sm:mt-0 mt-10 text-white" id="contact">
      <div className="sm:max-w-3xl w-full sm:w-[50%] sm:mx-auto  shadow-md shadow-green-950 rounded-lg p-4 mr-36  border-2 border-[#6A8086] ">
